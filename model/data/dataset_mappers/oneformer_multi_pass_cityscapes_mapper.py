...
__all__ = ["OneFormerUnifiedMultiPassCityscapesMapper"]


class OneFormerUnifiedMultiPassCityscapesMapper:
    """
    ...
    def process_segmentation_data(self, dataset_dict):
        ...
        left_image = utils.read_image(dataset_dict["file_name"], format=self.img_format, dataset='cs')
