...
class MSDeformAttnPixelDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.transformer_feature_strides = [
            v.stride for k, v in transformer_input_shape]  # to decide extra FPN layers
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        # use 1024 for deformable transformer encoder
    ...
    def forward_features(self, features):
        ...
        y, spatial_shapes, level_start_index, valid_ratios = self.transformer(
            srcs, pos)
        bs = y.shape[0]
...
@SEM_SEG_HEADS_REGISTRY.register()
class DepthMSDeformAttnPixelDecoder(nn.Module):
    @configurable
    def __init__(
        self,
        input_shape: Dict[str, ShapeSpec],
    ...
    def forward_features(self, features):
        ...
        disps = []
        for i, o in enumerate(out):
            disps.append(self.low_disp_outs[i](o))
