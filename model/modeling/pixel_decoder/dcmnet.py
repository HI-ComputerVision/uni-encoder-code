...
class DCMNet(nn.Module):
    ...
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec], *,
        ...
        self.depth_in_features = ['res2', 'res3', 'res4', 'res5']
    ...
    def forward_features(self, inputs):
        ...
        inputs = [inputs[i] for i in self.depth_in_features]
        ...
        self.outputs = [self.outputs[("disp", scale)] for scale in range(3, -1, -1)]
        return self.outputs
