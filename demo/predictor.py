...
class VisualizationDemo(object):
    def __init__(self, cfg, instance_mode=ColorMode.IMAGE, parallel=False):
        ...
        self.metadata = MetadataCatalog.get(
            cfg.DATASETS.SEG_TEST_PANOPTIC[0] if len(cfg.DATASETS.SEG_TEST_PANOPTIC) else "__unused"
        )
        if 'cityscapes_fine_sem_seg_val' in cfg.DATASETS.SEG_TEST_PANOPTIC[0]:
    ...
    def run_on_image(self, image, prev, task):
        """
        Args:
        ...
        if task == 'panoptic':
            ...
            predictions = self.predictor(image, prev, task)
        ...
        vis_output['depth_inference'] = predictions['depth_inference']
        vis_output['ind_flow_inference'] = predictions['ind_flow_inference']
        vis_output['mask_inference'] = predictions['mask_inference']
        vis_output['tot_flow_inference'] = predictions['tot_flow_inference']
